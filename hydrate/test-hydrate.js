...
class GridCol {
    constructor(hostRef) {
        ...
        this.getOffsetClassnames = () => {
            ...
            const offsetSClassname = (offsetS && offsetS !== offset) || (COLUMNS.S !== COLUMNS.XS)  ? `col-offset-s-${offsetS}` : '';
            const offsetMClassname = (offsetM && offsetM !== offsetS) ||  offsetM > 0 ? `col-offset-m-${offsetM}` : '';
            const offsetLClassname = (offsetL && offsetL !== offsetM) || (COLUMNS.L !== COLUMNS.M)  ? `col-offset-l-${offsetL}` : '';
            const offsetXLClassname = (offsetXL && offsetXL !== offsetL) || (COLUMNS.XL !== COLUMNS.L)  ? `col-offset-xl-${offsetXL}` : '';
        ...
        this.getOffsetRightClassnames = () => {
            ...
            const offsetRightSClassname = (offsetRightS && offsetRightS !== offsetRight) || (COLUMNS.S !== COLUMNS.XS)  ? `col-offsetRight-s-${offsetRightS}` : '';
            const offsetRightMClassname = (offsetRightM && offsetRightM !== offsetRightS) ||  offsetRightM > 0 ? `col-offsetRight-m-${offsetRightM}` : '';
            const offsetRightLClassname = (offsetRightL && offsetRightL !== offsetRightM) || (COLUMNS.L !== COLUMNS.M)  ? `col-offsetRight-l-${offsetRightL}` : '';
            const offsetRightXLClassname = (offsetRightXL && offsetRightXL !== offsetRightL) || (COLUMNS.XL !== COLUMNS.L)  ? `col-offsetRight-xl-${offsetRightXL}` : '';
